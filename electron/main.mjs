...
const youtubeTranscriptModuleUrl = new URL("../node_modules/youtube-transcript/dist/youtube-transcript.esm.js", import.meta.url)
let mainWindow = null
...
async function loadFetchTranscript() {
  const module = await import(youtubeTranscriptModuleUrl.href)
